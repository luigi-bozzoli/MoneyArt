...
abstract class AstaCreations {
	...
	*/
	...
	public static List<Asta> astaSixElementsWithArtistFollowersList() {
		List<Asta> aste = new ArrayList<>();
	...
	public static List<Asta> ongoingAstaTwoElementsWithArtistFollowersList() {
		List<Asta> aste = astaSixElementsWithArtistFollowersList();
		aste.remove(0);
		aste.remove(0);
		aste.remove(3);
		aste.remove(2);
	...
	public static List<Asta> endedAstaTwoElementsWithArtistFollowersList() {
		List<Asta> aste = astaSixElementsWithArtistFollowersList();
		aste.remove(5);
		aste.remove(4);
		aste.remove(3);
	...
	public static List<Asta> deletedAstaTwoElementsWithArtistFollowersList() {
		List<Asta> aste = astaSixElementsWithArtistFollowersList();
		aste.remove(0);
		aste.remove(0);
		aste.remove(0);
	...
	public static List<Asta> createdAstaTwoElementsList() {
		List<Asta> aste = new ArrayList<>();
		...
		Asta a1 = new Asta(o1, new Date(System.currentTimeMillis() + 4 * DAY_MILLIS), new Date(System.currentTimeMillis() + 6 * DAY_MILLIS), Asta.Stato.CREATA);
		a1.setId(1);
		...
		Asta a2 = new Asta(o2, new Date(System.currentTimeMillis() + 7 * DAY_MILLIS), new Date(System.currentTimeMillis() + 14 * DAY_MILLIS), Asta.Stato.CREATA);
		a2.setId(2);
	...
	public static List<Asta> createdAstaTwoElementsWithArtistFollowersList() {
		List<Asta> aste = new ArrayList<>();
	...
	public static List<Asta> ongoingAstaTwoElementsListSortedByArtistFollowersDesc() {
		List<Asta> aste = astaSixElementsWithArtistFollowersList();
		aste.remove(0);
		aste.remove(0);
		aste.remove(3);
	...
	public static List<Asta> ongoingAstaTwoElementsListSortedByArtistFollowersAsc() {
		List<Asta> aste = astaSixElementsWithArtistFollowersList();
		aste.remove(0);
		aste.remove(0);
		aste.remove(3);
	...
	public static List<Asta> endedAstaTwoElementsListSortedByArtistFollowersDesc() {
		List<Asta> aste = astaSixElementsWithArtistFollowersList();
		aste.remove(5);
		aste.remove(4);
		aste.remove(3);
	...
	public static List<Asta> endedAstaTwoElementsListSortedByArtistFollowersAsc() {
		List<Asta> aste = astaSixElementsWithArtistFollowersList();
		aste.remove(5);
		aste.remove(4);
		aste.remove(3);
	...
	public static List<Asta> deletedAstaTwoElementsListSortedByArtistFollowersDesc() {
		List<Asta> aste = astaSixElementsWithArtistFollowersList();
		aste.remove(0);
		aste.remove(0);
		aste.remove(0);
	...
	public static List<Asta> deletedAstaTwoElementsListSortedByArtistFollowersAsc() {
		List<Asta> aste = astaSixElementsWithArtistFollowersList();
		aste.remove(0);
		aste.remove(0);
		aste.remove(0);
	...
	public static List<Asta> createdAstaTwoElementsListSortedByArtistFollowersDesc() {
		List<Asta> aste = createdAstaTwoElementsWithArtistFollowersList();
		Collections.swap(aste, 0, 1);
		return aste;
	}

	public static List<Asta> createdAstaTwoElementsListSortedByArtistFollowersAsc() {
		List<Asta> aste = createdAstaTwoElementsWithArtistFollowersList();
		return aste;
	}
}
