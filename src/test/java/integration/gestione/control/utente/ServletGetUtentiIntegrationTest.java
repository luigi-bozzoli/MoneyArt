...
import it.unisa.c02.moneyart.gestione.utente.control.ServletGetUtenti;
...
class ServletGetUtentiIntegrationTest {

  private static DataSource dataSource;
  private ServletGetUtenti servletGetUtenti;
  ...
  public void setUp() throws SQLException, FileNotFoundException, NoSuchFieldException,
    IllegalAccessException, NoSuchMethodException, InvocationTargetException, ServletException {
    ...
    servletGetUtenti = new ServletGetUtenti();

    config = mock(ServletConfig.class);
    servletGetUtenti.init(config);

    Field injectedObject = servletGetUtenti.getClass().getDeclaredField("utenteService");
    injectedObject.setAccessible(true);
    injectedObject.set(servletGetUtenti, utenteService);
  ...
  @Test
  @DisplayName("doGet Ajax Filter Test")
  void doGetAjaxFilter() throws IOException, NoSuchMethodException,
    ...
    when(request.getParameter("criteria")).thenReturn("criteria");
    ...
    Method privateStringMethod = ServletGetUtenti.class
      .getDeclaredMethod("doGet", HttpServletRequest.class, HttpServletResponse.class);

    privateStringMethod.setAccessible(true);
    privateStringMethod.invoke(servletGetUtenti, request, response);
  ...
  @Test
  @DisplayName("doGet Ajax Test")
  void doGetAjax() throws IOException, NoSuchMethodException,
    InvocationTargetException, IllegalAccessException {
  ...
  @Test
  @DisplayName("doGet NoAjax Test")
  void doGetNoAjax() throws IOException, NoSuchMethodException,
    InvocationTargetException, IllegalAccessException {
