...
VALUES ((SELECT id FROM utente WHERE username = "XJustUnluckyX"), (SELECT id FROM utente WHERE username = "alfcan"), "The Shibosis", "Descrizione", 0x717171, NULL, "IN_POSSESSO");
