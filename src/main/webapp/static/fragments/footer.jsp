...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
    ...
    <div class="content-wrapper">
        <img src="${pageContext.servletContext.contextPath}/static/image/wave-footer.svg" alt="">
                    ...
                    <div class="col-md-4 mb-md-0" style="text-align: center;">
                        ...
                        <div class="container mb-3">
                            ...
                            <div class="social-buttons">
                                ...
                                <a class="social"><i class="fab fa-discord"></i></a>
                            </div>
                        </div>
                        ...
                        <div class="container mb-3">
                            ...
                            <div class="social-buttons">
                                ...
                                <p class="payment-method"><i class="fab fa-cc-visa"></i></p>
